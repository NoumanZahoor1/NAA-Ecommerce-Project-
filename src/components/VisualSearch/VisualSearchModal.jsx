...
import { FaTimes, FaUpload, FaSpinner, FaCheckCircle, FaBolt } from 'react-icons/fa';
                                ...
                                >
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex justify-center pt-4">
                                            <button className="px-10 py-5 bg-black dark:bg-white text-white dark:text-black rounded-2xl font-bold text-base hover:scale-105 transition-all shadow-2xl flex items-center gap-2">
                                                <FaUpload className="text-sm" /> Select from Device
                                            </button>
                                        </div>
                                    </div>
                                </div>
