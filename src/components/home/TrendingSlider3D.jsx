...
const TrendingSlider3D = ({ products = [] }) => {
    ...
    return (
        <section className="relative min-h-[70vh] md:min-h-[85vh] dark:bg-[#08080a] bg-stone-50 transition-colors duration-500 overflow-hidden py-16 md:py-24" style={{ fontFamily: "'Inter', sans-serif" }}>
            {/* Ambient Background */}
            ...
            <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                ...
                {/* 3D Stage */}
                <div
                    className="relative w-full h-[450px] md:h-[750px] flex items-center justify-center"
                    ...
                    onTouchEnd={onEnd}
                >
                    <div className="relative w-[420px] h-[600px] scale-[0.65] sm:scale-[0.8] md:scale-100" style={{ transformStyle: "preserve-3d" }}>
                        {offsets.map((off) => {
