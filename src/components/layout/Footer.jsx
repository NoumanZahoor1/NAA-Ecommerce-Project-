...
const Footer = () => {
    ...
    return (
        <footer className="footer-container bg-white dark:bg-black text-black dark:text-white pt-24 pb-12 overflow-hidden relative transition-colors duration-500">
            {/* SVG Grain Filter — No external dependencies */}
            ...
            <div className="absolute inset-0 pointer-events-none z-0 opacity-100" style={{ filter: 'url(#footer-grain)' }} />
