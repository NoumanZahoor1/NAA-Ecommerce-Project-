...
const initialProducts = [
    ...
    { id: '5f4d1e2b4f1d4b0017a1a056', name: 'Knit Polo Sweater', price: 65.00, category: 'Men', image: 'https://images.unsplash.com/photo-1598033129183-c4f50c7176c8?auto=format&fit=crop&w=800&q=80', images: ['https://images.unsplash.com/photo-1598033129183-c4f50c7176c8?auto=format&fit=crop&w=800&q=80'], rating: 4.6, stock: 12, sizes: ['S', 'M', 'L'], colors: ['navy', 'gray'], description: 'Soft merino blend knit polo with a sophisticated drape.', fit: 'Regular' },
